		...
		>
			<template #item="{ item, index }">
				<div class="flex rounded">
					...
					>
						<template #icon>
							<SortAscIcon
								...
								stroke-width="1.5"
							/>
							<SortDescIcon v-else class="h-4 w-4 text-black-700" stroke-width="1.5" />
						</template>
					</Button>
					...
					>
						<template #icon>
							<X class="h-4 w-4 text-black-700" stroke-width="1.5" />
						</template>
					</Button>
				</div>
			</template>
		...
		>
			<template #target="{ togglePopover }">
				<Button class="w-full" @click="togglePopover">
					<template #prefix>
						<Plus class="h-4 w-4 text-black-700" stroke-width="1.5" />
					</template>
					Add Sort
				</Button>
			</template>
